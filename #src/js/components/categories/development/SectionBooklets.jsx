						...
						<div className="service-description__description">
							<div className="service-description__row">
								<p><i className="icon-hand-pointer _icon"></i>
									...
									профессионалов готова воплотить в&nbsp;жизнь ваши самые смелые
									идеи и&nbsp;создать уникальный дизайн, который будет отражать
									вашу&nbsp;индивидуальность и&nbsp;стиль.
								</p>
								<p><i className="icon-hand-pointer _icon"></i>
									Мы специализируемся на&nbsp;разработке логотипов, брендбуков,
								...
								<p><i className="icon-hand-pointer _icon"></i>
									...
									среди конкурентов. Доверьтесь нам и&nbsp;получите качественный
								...
								<div className="service-description__items">
									...
									<div className="service-description__list-item">
										...
										<ul>
											...
											<li><i className="icon-check _icon"></i>Презентация;</li>
											<li><i className="icon-check _icon"></i>
									...
									<div className="service-description__list-item">
										...
										<ul>
											<li><i className="icon-check _icon"></i>
												Визитка, листовка, буклет, бланк и тд;
											</li>
											<li><i className="icon-check _icon"></i>
