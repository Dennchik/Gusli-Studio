						...
						<div className="service-description__description">
							<div className="service-description__row">
								...
								<p><i className="icon-hand-pointer _icon"></i>
									...
									и&nbsp;мелодий, которые подчеркнут каждый момент вашей жизни.
								...
								<div className="service-description__items">
									<div className="service-description__list-item-col">
										<ul>
											<li><i className="icon-musical-notes _icon"></i>
												<p>Не упустите возможность превратить обыденные моменты
													в&nbsp;нечто&nbsp;особенное с&nbsp;нашими подборками
													и&nbsp;плейлистами. Доверьтесь профессионалам
													и&nbsp;насладитесь музыкой в&nbsp;полной мере.
													Сделайте
													заказ прямо сейчас и&nbsp;откройте для&nbsp;себя новые
													звуки!</p>
											</li>
											<li><i className="icon-musical-notes _icon"></i>
												<p>Индивидуальный подход: Мы &nbsp;создаем каждый
													плейлист
													с &nbsp;учетом ваших предпочтений, настроения
													и &nbsp;целей,
													чтобы&nbsp;предоставить вам&nbsp;уникальный саундтрек,
													который идеально подходит именно вам;</p>
											</li>
											<li><i className="icon-musical-notes _icon"></i>
												<p>Наши профессиональные кураторы тщательно отбирают
													треки
													для&mnsp;каждого плейлиста, учитывая последние тренды
									...
									<div className="service-description__list-item-col">
										<ul>
											<li><i className="icon-musical-notes _icon"></i>
												<p>Вы можете заказать у&nbsp;нас сборник
													или&nbsp;плейлист
													быстро и&nbsp;легко, просто оставив заявку
													на&nbsp;нашем
													сайте. Мы&nbsp;гарантируем высокое качество звука
													и&nbsp;отбор только лучших треков для&nbsp;вашего
													плейлиста;</p>
											</li>
											<li><i className="icon-musical-notes _icon"></i>
												<p>Не упустите возможность создать неповторимую
													атмосферу
													в&nbsp;любой ситуации с&nbsp;помощью индивидуального
													саундтрека, который подчеркнет
