									...
									<div className="services-slide__column line">
										<a href={getPath('services/events/events-festival.html')}
											...
											<div className="services-slide__image el">
												...
												<picture>
													{isWebpSupported() ? (
														<img className="services-slide__img" src={getPath('img/cards/events/img_1.webp')} alt="image" />
													) : (
														<img className="services-slide__img" src={getPath('img/cards/events/img_1.png')} alt="image" />
													)}
												</picture>
												<picture>
													{isWebpSupported() ? (
									...
									<div className="services-slide__column line">
										<a href={getPath('services/events/events-leader.html')}
											...
											<div className="services-slide__image el">
												...
												<picture>
													{isWebpSupported() ? (
														<img className="services-slide__img" src={getPath('img/cards/events/img_2.webp')} alt="image" />
													) : (
														<img className="services-slide__img" src={getPath('img/cards/events/img_2.png')} alt="image" />
													)}
												</picture>
												<picture>
													{isWebpSupported() ? (
									...
									<div className="services-slide__column line">
										<a href={getPath('services/events/events-dj.html')}
											...
											<div className="services-slide__image el">
												...
												<picture>
													{isWebpSupported() ? (
														<img className="services-slide__img" src={getPath('img/cards/events/img_3.webp')} alt="image" />
													) : (
														<img className="services-slide__img" src={getPath('img/cards/events/img_3.png')} alt="image" />
													)}
												</picture>
												<picture>
													{isWebpSupported() ? (
									...
									<div className="services-slide__column line">
										<a href={getPath('services/events/events-animators.html')}
											...
											<div className="services-slide__image el">
												...
												<picture>
													{isWebpSupported() ? (
														<img className="services-slide__img" src={getPath('img/cards/events/img_4.webp')} alt="image" />
													) : (
														<img className="services-slide__img" src={getPath('img/cards/events/img_4.png')} alt="image" />
													)}
												</picture>
												<picture>
													{isWebpSupported() ? (
										...
										<a href={getPath('services/events/events-rent.html')}
											...
											<div className="services-slide__image el">
												<div className="services-slide__image el">
													...
													<picture>
														{isWebpSupported() ? (
															<img className="services-slide__img" src={getPath('img/cards/events/img_5.webp')} alt="image" />
														) : (
															<img className="services-slide__img" src={getPath('img/cards/events/img_5.png')} alt="image" />
														)}
													</picture>
													<picture>
														{isWebpSupported() ? (
