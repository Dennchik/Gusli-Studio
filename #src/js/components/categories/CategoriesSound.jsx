...
//* ----------------------------------------------------------------------------
export const CategoriesSound = ({ baseUrl }) => {
								...
								<div className="services-slide__column line">
									<div className="services-slide__content">
										<div className="services-slide__image el">
											...
											<a href={getPath('@@webRoot/service-video.html')}>
												<picture>
													{isWebpSupported() ? (
														<img
															src={getPath(
								...
								<div className="services-slide__column line">
									<div className="services-slide__content">
										<div className="services-slide__image el">
											...
											<a href={getPath('@@webRoot/service-text.html')}>
												<picture>
													{isWebpSupported() ? (
														<img
															src={getPath(
														...
														<img
															src={getPath('@@webRoot/img/main/body/img_8.png')}
															alt="image-8"
														/>
													)}
												</picture>
								...
								<div className="services-slide__column line">
									<div className="services-slide__content">
										<div className="services-slide__image el">
											...
											<a href={getPath('@@webRoot/service-events.html')}>
												<picture>
													{isWebpSupported()
														? (<img
															src={getPath(
