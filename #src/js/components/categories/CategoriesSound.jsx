...
export const CategoriesSound = () => {
	...
	return (
		<div className="categories-sound">
			<div className="categories-sound__body">
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/service-sound.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_6.webp'}
																alt="image-6"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_6.png'}
																alt="image-6"
															/>
														)}
													</picture>
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/service-video.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_7.webp'}
																alt="image-7"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_7.png'}
																alt="image-7"
															/>
														)}
													</picture>
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/service-text.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_8.webp'}
																alt="image-8"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_8.png'}
																alt="image-8"
															/>
														)}
													</picture>
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/service-events.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_9.webp'}
																alt="image-9"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_9.png'}
																alt="image-9"
															/>
														)}
													</picture>
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/other-services.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_10.webp'}
																alt="image-10"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_10.png'}
																alt="image-10"
															/>
														)}
													</picture>
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/service-sound.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_11.webp'}
																alt="image-11"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_11.png'}
																alt="image-1"
															/>
														)}
													</picture>
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/service-sound.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_12.webp'}
																alt="image-12"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_12.png'}
																alt="image-12"
															/>
														)}
													</picture>
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/service-sound.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_13.webp'}
																alt="image-13"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_13.png'}
																alt="image-13"
															/>
														)}
													</picture>
											...
											<div className="services-slide__image el">
												...
												<a href="@@webRoot/service-sound.html">
													<picture>
														{isWebpSupported() ? (
															<img
																src={'@@webRoot/img/main/body/img_15.webp'}
																alt="image-15"
															/>
														) : (
															<img
																src={'@@webRoot/img/main/body/img_15.png'}
																alt="image-15"
															/>
														)}
													</picture>
