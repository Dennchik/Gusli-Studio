						...
						<div className="service-description__description">
							<div className="service-description__row">
								...
								<ul className="service-description__sub-items">
									<li><i className="icon-check _icon"></i>
										Сведение&nbsp-<span>&nbsp;4990&nbsp;рублей</span>.
									</li>
									<li><i className="icon-check _icon"></i>
							...
							<div className="service-description__row">
								...
								<ul className="service-description__sub-items">
									...
									<li><i className="icon-check _icon"></i>Эквализация, улучшение
										стерео;
									</li>
									<li><i className="icon-check _icon"></i>Приведение всего
										релизу к&nbsp;одному звучанию.
									</li>
									<h3>Цены:</h3>
									<li><i className="icon-check _icon"></i>Мастеринг
										- <span>2&nbsp;490&nbsp;руб</span>.
									</li>
									<h3>Сроки выполнения:</h3>
									<li><i className="icon-check _icon"></i>до 5 дней;</li>
									<li><i className="icon-check _icon"></i>24&nbsp;часа
										(х2&nbsp;от&nbsp;стоимости&nbsp;услуги).
									</li>
						...
						<div className="service-description__description">
							<div className="service-description__row">
								<p><i className="icon-head-phones _icon"></i>
									...
									достоинства и&nbsp;недостатки сведения. Поэтому рекомендуется,
									чтобы&nbsp;сведение и&nbsp;мастеринг проводили разные
									люди (но, конечно, из&nbsp;любого правила есть исключения).
									Слух мастеринг-инженера должен по-своему воспринимать
									фонограмму&nbsp;– сразу слышать достоинства и&nbsp;недостатки
