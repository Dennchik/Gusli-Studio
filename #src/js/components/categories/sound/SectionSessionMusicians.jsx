								...
								<div className="service-description__items">
									<div className="service-description__list-item-col">
										<p><i className="icon-guitar-line _icon"></i><span>Сессионный музыкант</span>,
											...
											—&nbsp;это&nbsp;профессионал,
											который принимает участие в&nbsp;записи
											на&nbsp;определенный
											период времени. Он&nbsp;обладает большим опытом
											в&nbsp;звукозаписи и&nbsp;помогает сделать звук более
											живым
											и
										...
										<p>Цена за <span>1 час </span>работы сессионного музыканта
											...
											отдельно.</p>
										<ul>
											<li><i className="icon-guitar-line _icon"></i>Мы
												сотрудничаем
											...
											<li><i className="icon-guitar-line _icon"></i>Труба,
												флейта,
												кларнет и&nbsp;другие инструменты;
											</li>
											<li><i className="icon-guitar-line _icon"></i>Барабаны,
												гонг,
