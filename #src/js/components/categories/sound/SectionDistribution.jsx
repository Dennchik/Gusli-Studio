			...
			<div className="service-description__column">
				<div className="material-parallax parallax">
					<div className="parallax__image">
						<picture>
							{isWebpSupported() ? (
								<img className="parallax__image-services bg" src={getPath('img/parallax/sound/fotoram_bg_04.webp')} alt="image" />
							) : (
								<img className="parallax__image-services bg" src={getPath('img/parallax/sound/fotoram_bg_04.png')} alt="image" />
							)}
						</picture>
					</div>
				</div>
						...
						<div className="service-description__description">
							...
							<div className="service-description__row">
								<div className="service-description__row-col">
									...
									<ul>
										<li><i className="icon-check _icon"></i><p>выгрузка трека на&nbsp;площадки&nbsp;— <span>1500&nbsp;рублей</span>;</p></li>
										<li><i className="icon-check _icon"></i><p>высокая доходность от&nbsp;прослушиваний;</p></li>
										<li><i className="icon-check _icon"></i><p>круглосуточная поддержка менеджера;</p></li>
										<li><i className="icon-check _icon"></i><p>страница со&nbsp;ссылками уже включена в&nbsp;стоимость;</p></li>
										<li><i className="icon-check _icon"></i><p>оперативное размещение релиза.</p></li>
									</ul>
								</div>
								<div className="service-description__row-col">
									<h3>Дополнительные услуги:</h3>
									<ul>
										<li><i className="icon-check _icon"></i><p>обложка от&nbsp;<span>1000&nbsp;рублей</span>;</p></li>
										<li><i className="icon-check _icon"></i><p>анимация обложки от&nbsp; <span>5000&nbsp;рублей</span></p>;</li>
										<li><i className="icon-check _icon"></i><p>составление пресс релиза и&nbsp;питчинг <span> по&nbsp;договоренности</span>;</p></li>
										<li><i className="icon-check _icon"></i><p>размещение в&mnsp;плейлистах <span> по&nbsp;договоренности</span>.</p></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div className='service-description__content _container'>
						<div className="service-description__description">
							...
							<div className="service-description__row">
								...
								<div className="service-description__row-col">
									<h3><i className="icon-volume-high _icon"></i>Питчинг релизов</h3>
									<p><i className="icon-hand-pointer _icon"></i>Отправляет ваши треки редакторам площадок для&nbsp;последующего попадания в&nbsp;плейлисты и&nbsp;на&nbsp;витрины сервисов. Чтобы попасть в&nbsp;рассылку, необходимо загрузить релиз хотя бы&nbsp;за 14&nbsp;дней до&nbsp;даты выпуска и&nbsp;подготовить небольшое писание, именно от&nbsp;него зависит, будет ли&nbsp;ваш материал замечен.</p>
