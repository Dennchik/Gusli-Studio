					...
					<div className="service-description__content _container">
						...
						<div className="service-description__description">
							...
							<div className="service-description__row">
								<div className="service-description__items">
									<div className="service-description__list-item-col">
										<p><i className="icon-guitar-line _icon"></i>Профессионализм
										...
										<p><i className="icon-guitar-line _icon"></i>Мы&nbsp;ценим
										...
										<p><i className="icon-guitar-line _icon"></i>Наша студия
									...
									<div className="service-description__list-item-col">
										<p>
											...
											оперативное выполнение заказов, чтобы вы&nbsp;могли
											радовать
											своих слушателей новыми аранжировками в&nbsp;срок.
										</p>
										<p><i className="icon-guitar-line _icon"></i>Наша студия
											имеет свой неповторимый стиль, который поможет придать
											вашей
											музыке особую изюминку. Мы&nbsp;создаем аранжировки,
											которые
											отражают вашу индивидуальность и&nbsp;помогают вам
											выразить
											свое творческое видение.
										</p>
										<p><i className="icon-guitar-line _icon"></i>Доверьтесь
											профессионалам и&nbsp;создайте звук, который запомнится
											надолго!
										</p>
										<p>Цены на&nbsp;написание
											аранжировки <span>от&nbsp;10&nbsp;000
									рублей</span>. </p>
									</div>
								</div>
							</div>
