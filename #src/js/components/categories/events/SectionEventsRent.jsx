			...
			<div className="service-description__column-parallax">
						...
						<picture>
							{isWebpSupported() ? (
									<img className="parallax__image-services"
											 src={getPath('img/parallax/events/fotoram_bg_06.webp')}
											 alt="image" />
								)
								: (
									<img className="parallax__image-services bg"
											 src={getPath('img/parallax/events/fotoram_bg_06.png')}
											 alt="image" />
								)}
						</picture>
					</div>
				...
				<div className="service-description__body top-box">
					<div className='service-description__content _container'>
						<h1 className="service-description__title events-rent-title">
							Аренда оборудования
						</h1>
						<div className="service-description__description">
							<div className="service-description__row">
								<p><i className="icon-hand-pointer _icon"></i>
									...
									с&nbsp;помощью аренды оборудования! Мы&nbsp;предлагаем широкий
									выбор профессионального звукового, светового
								...
								<p><i className="icon-hand-pointer _icon"></i>
									...
									мероприятие, концерт или&nbsp;выставку&nbsp;- мы&nbsp;поможем
									создать атмосферу, которая запомнится вашим гостям надолго.
									Сделайте ваше мероприятие ярким и&nbsp;профессиональным
									с&nbsp;помощью аренды оборудования от&nbsp;нашей компании!
								</p>
								<p className="service-description__ps">Предлагаем услуги проката
									звукового и&nbsp;светового оборудования высшего качества
