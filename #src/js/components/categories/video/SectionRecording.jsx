								...
								<div className="service-description__items">
									<div className="service-description__list-item-col">
										...
										<p><i className="icon-camera-film _icon"></i>Корпоративная
											...
											ситуациях. Главным форматом корпоративной видеосъемки
											является
											фильм, который рассказывает о&nbsp;компании
											или&nbsp;продукте
									...
									<div className="service-description__list-item-col">
										...
										<ul>
											<li><i className="icon-clapper _icon"></i>
												<p>Съемка короткометражного фильма (1-2&nbsp;дня):&emsp;
													<span>от&nbsp;100&nbsp;000&nbsp;рублей</span> и&nbsp;выше;
												</p>
											</li>
											<li><i className="icon-clapper _icon"></i>
												<p>Съемка интервью (полдня):&emsp;
													<span>от&nbsp;15&nbsp;000&nbsp;рублей</span>;</p>
											</li>
											<li><i className="icon-clapper _icon"></i>
												<p>Съемка рекламного ролика (1&nbsp;день):&emsp;
