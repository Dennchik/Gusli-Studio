							...
							<div className="service-description__row">
								<div className="service-description__items">
									<div className="service-description__list-item-col">
										...
										<ul>
											<li><i className="icon-check _icon"></i>Обсуждение
												проекта.
												Нужно познакомиться с&nbsp;музыкальной композицией,
												подобрать референсные видео, обсудить бюджет и&nbsp;идею
												клипа. Затем подписать договор на&nbsp;съёмку
												и&nbsp;сроки
												сдачи проекта;
											</li>
											<li><i className="icon-check _icon"></i>Разработка
												сценария.
												В &nbsp;течение трёх дней пишут черновой сценарий,
												обсуждают
											...
											<li><i className="icon-check _icon"></i>Съёмка клипа.
												...
												освещение, создают задуманную атмосферу клипа
												с&nbsp;помощью
