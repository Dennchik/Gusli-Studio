			...
			<div className="service-description__column-parallax">
				...
				<div className="service-description__body top-box">
					<div className='service-description__content _container'>
						<h1 className="service-description__title text-scenarios-title">
							Написание сценариев
						</h1>
						<div className="service-description__description">
							<div className="service-description__row">
								...
								<p><i className="icon-hand-pointer _icon"></i>
									Мы можем написать сценарий на&nbsp;основе вашей или&nbsp;нашей
								...
								<p><i className="icon-hand-pointer _icon"></i>
									Мы можем переработать или доработать готовый или&nbsp;частично
									готовый сценарий, книгу или&nbsp;идею. Мы доработаем
									ваш&nbsp;материал до&nbsp;совершенства в&nbsp;рамках
									поставленных задач, при&nbsp;этом сохранив авторство оригинала
								</p>
								...
								<p><i className="icon-hand-pointer _icon"></i>
									...
									оценку всех нюансов сценария по&nbsp;широкому ряду критериев
								</p>
								...
								<p>Мы создадим графическую презентацию высочайшего качества,
									...
									представить предстоящий проект партнерам и&nbsp;сотрудникам.
								</p>
							</div>
						</div>
					</div>
