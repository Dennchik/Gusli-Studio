...
//* ----------------------------------------------------------------------------
export const ServiceSound = ({ baseUrl, Uslugi }) => {
	console.log(Uslugi);
	...
	}, [location.pathname, isHomepage, Uslugi]);
		...
		<div className="services-slide__svg">
			<svg viewBox="0 0 700 430">
				<g fill="none" fillRule="evenodd" stroke="currentColor"
				   strokeWidth="1" className="lines">
					<style
						type="text/css"> {`.el{fill:none;stroke:#fff;stroke-width:8;stroke-miterlimit:10;}`}
					</style>
					<path className="el"
								...
								<div className="services-slide__body _swiper">
									{Uslugi && Uslugi.length > 0 ? (
										<>
											{(() => {
												let serviceElements = [];
												for (let i = 0; i < Uslugi.length; i += 2) {
													serviceElements.push(
														<div className="services-slide__column line" key={i}>
															<a href={Uslugi[i].url} className="services-slide__content">
																<div className="services-slide__image el">
																	{SVG[i % SVG.length]} {/* SVG ni sikl orqali olish */}
																	...
																	<div className="services-slide__text">
																		<p>{Uslugi[i].title}</p>
																		{Uslugi[i].price !== '' && <p>{Uslugi[i].price}</p>}
																	</div>
																</div>
															</a>

															{/* Agar keyingi element mavjud bo'lsa, uni ham qo'shish */}
															{Uslugi[i + 1] && (
																<a href={Uslugi[i + 1].url} className="services-slide__content">
																	<div className="services-slide__image el">
																		{SVG[(i + 1) % SVG.length]}
																		<div className="services-slide__picture">
																			<picture>
																		...
																		<div className="services-slide__text">
																			<p>{Uslugi[i + 1].title}</p>
																			{Uslugi[i + 1].price !== '' && <p>{Uslugi[i + 1].price}</p>}
																		</div>
																	</div>
																</a>
															)}
